...
class BattleWithCode extends Component {
  constructor(props) {
    super(props);
    this.state = {
      selectLanguageId: 0,
            ...
            <div className="col-6">
              ...
              <div className="mt-4">
                ...
                <button className="hover_pointer btn p-0 m-2">
                  <div
                    class="card m-0 p-0 text-center border_buttons text-dark py-4"
                    onClick={this.onclick_difficulty.bind(this, 3, "Hard")}
                    style={{ width: "12rem" }}
                  >
                    <div class="card-body">
                      <h5 class="card-title m-auto">Hard</h5>
...
export default connect(mapStateToProps, mapDispatchToProps)(BattleWithCode);